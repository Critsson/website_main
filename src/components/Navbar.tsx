...
export const Navbar = () => {
    return (
        <div className="nav_wrapper">
            ...
            <Typography sx={{ color: "#AEE728", fontSize: "4vw", fontWeight: "700", marginBottom: "-.2vw", flexGrow: 1, "&:hover": {cursor: "default" }}} variant="h1">.</Typography>
            <Stack direction="row" alignItems="center" spacing=".5vw" marginTop="1vw">
                <Button sx={{ color: "white", textTransform: "none" }} onClick={() => window.scrollTo({top: 0, behavior: "smooth"})}>

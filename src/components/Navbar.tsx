  ...
  return (
    <div className="nav_wrapper_mobile nav_wrapper">
      ...
      <div className="nav_buttons_container nav_buttons_container_mobile">
        <a
          href="#Home"
          className="nav_button_container nav_button_container_mobile"
        >
          {windowWidth > 640 ? (
            <>
              <Typography
            ...
            <>
              <Typography
                variant="h3"
                sx={{ fontSize: "5vw", fontWeight: "700" }}
              >
                Home
              </Typography>
              <Typography
        ...
        <a
          href="https://drive.google.com/file/d/1-yg0kPRH_dpCLD5XqTxzeU99N-U_YfzJ/view?usp=share_link"
          target="_blank"
          rel="noreferrer"
          className="nav_button_container nav_button_container_mobile"
        >

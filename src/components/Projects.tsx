...
export const Projects = () => {
  ...
  return (
    <>
      {windowWidth > 640 ? <div style={{ height: "100vh", flexShrink: "0", scrollSnapAlign: "start", display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "2vh" }} id="Projects">
